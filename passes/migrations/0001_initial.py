# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-12 16:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middle_names', models.CharField(blank=True, max_length=20)),
                ('surname', models.CharField(max_length=20)),
                ('previous_surname', models.CharField(blank=True, max_length=50)),
                ...
                ('line_manager', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='passes.Person')),
            ],
        ),
        migrations.CreateModel(
            name='ProofIdType',
